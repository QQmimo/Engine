...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _GameEngine__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./GameEngine */ \"./GameEngine/index.ts\");\n\nconst screen = new _GameEngine__WEBPACK_IMPORTED_MODULE_0__.GameScreen(document.body, 800, 600);\nconst world = screen.addLayer('world');\nconst cubeBlue = new _GameEngine__WEBPACK_IMPORTED_MODULE_0__.GameObject('blue', _GameEngine__WEBPACK_IMPORTED_MODULE_0__.Shape);\ncubeBlue.Transform.Position = { X: 425, Y: 300 };\nconst cubeBlueShape = cubeBlue.getComponent(_GameEngine__WEBPACK_IMPORTED_MODULE_0__.Shape);\ncubeBlueShape === null || cubeBlueShape === void 0 ? void 0 : cubeBlueShape.setBackground('blue');\ncubeBlueShape === null || cubeBlueShape === void 0 ? void 0 : cubeBlueShape.setStroke(1);\ncubeBlueShape === null || cubeBlueShape === void 0 ? void 0 : cubeBlueShape.drawByDots({ X: -25, Y: -25 }, { X: 25, Y: -25 }, { X: 25, Y: 25 }, { X: -25, Y: 25 });\nworld.addObject(cubeBlue);\nconst cubeRed = new _GameEngine__WEBPACK_IMPORTED_MODULE_0__.GameObject('red', _GameEngine__WEBPACK_IMPORTED_MODULE_0__.Shape);\ncubeRed.Transform.Position = { X: 400, Y: 300 };\nconst cubeRedShape = cubeRed.getComponent(_GameEngine__WEBPACK_IMPORTED_MODULE_0__.Shape);\ncubeRedShape === null || cubeRedShape === void 0 ? void 0 : cubeRedShape.setBackground('red');\ncubeRedShape === null || cubeRedShape === void 0 ? void 0 : cubeRedShape.setStroke(1);\ncubeRedShape === null || cubeRedShape === void 0 ? void 0 : cubeRedShape.drawByDots({ X: -25, Y: -25 }, { X: 25, Y: -25 }, { X: 25, Y: 25 }, { X: -25, Y: 25 });\nworld.addObject(cubeRed);\nconst cubeGreen = new _GameEngine__WEBPACK_IMPORTED_MODULE_0__.GameObject('green', _GameEngine__WEBPACK_IMPORTED_MODULE_0__.Shape);\ncubeGreen.Transform.Position = { X: 450, Y: 350 };\nconst cubeGreenShape = cubeGreen.getComponent(_GameEngine__WEBPACK_IMPORTED_MODULE_0__.Shape);\ncubeGreenShape === null || cubeGreenShape === void 0 ? void 0 : cubeGreenShape.setBackground('green');\ncubeGreenShape === null || cubeGreenShape === void 0 ? void 0 : cubeGreenShape.setStroke(1);\ncubeGreenShape === null || cubeGreenShape === void 0 ? void 0 : cubeGreenShape.drawByDotsCount(25, 150);\nworld.addObject(cubeGreen);\nsetInterval(() => {\n    cubeRed.Transform.Rotation.setAsDegree(-1);\n    cubeBlue.Transform.Rotation.setAsDegree(20);\n}, 100);\nsetTimeout(() => {\n    cubeRedShape.setOpacity(0.25);\n    cubeGreenShape.setOpacity(0.15);\n}, 2000);\nlet bodyW = 0;\nlet bodyH = 0;\nfunction resize() {\n    bodyW = screen.Canvas.width = innerWidth;\n    bodyH = screen.Canvas.height = innerHeight;\n}\nresize();\nwindow.addEventListener(\"resize\", resize);\nscreen.runLoop();\nconsole.log(_GameEngine__WEBPACK_IMPORTED_MODULE_0__.GameObject.findAllWith(_GameEngine__WEBPACK_IMPORTED_MODULE_0__.Shape));\n\n\n//# sourceURL=webpack://engine/./app.ts?");
