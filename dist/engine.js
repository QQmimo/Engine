...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _GameEngine__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./GameEngine */ \"./GameEngine/index.ts\");\n\nconst screen = new _GameEngine__WEBPACK_IMPORTED_MODULE_0__.GameScreen(document.body, 800, 600);\nconst world = screen.addLayer('world');\nconst circleRed = new _GameEngine__WEBPACK_IMPORTED_MODULE_0__.GameObject('red', _GameEngine__WEBPACK_IMPORTED_MODULE_0__.Shape);\ncircleRed.Transform.Position = { X: 150, Y: 150 };\nconst circleRedRenderer = circleRed.getComponent(_GameEngine__WEBPACK_IMPORTED_MODULE_0__.Shape);\ncircleRedRenderer === null || circleRedRenderer === void 0 ? void 0 : circleRedRenderer.setBackground('red');\ncircleRedRenderer === null || circleRedRenderer === void 0 ? void 0 : circleRedRenderer.setStroke(1, 'black');\ncircleRedRenderer === null || circleRedRenderer === void 0 ? void 0 : circleRedRenderer.draw({ X: -25, Y: -25 }, { X: 25, Y: -25 }, { X: 25, Y: 25 }, { X: -25, Y: 25 });\nworld.addObject(circleRed);\nsetInterval(() => {\n    let degree = circleRed.Transform.Rotation.getAsDegree();\n    circleRed.Transform.Rotation.setAsDegree((degree >= 360 ? 0 : degree) + 1);\n}, 100);\nlet bodyW = 0;\nlet bodyH = 0;\nfunction resize() {\n    bodyW = screen.Canvas.width = innerWidth;\n    bodyH = screen.Canvas.height = innerHeight;\n}\nresize();\nwindow.addEventListener(\"resize\", resize);\nscreen.runLoop();\n\n\n//# sourceURL=webpack://engine/./app.ts?");
