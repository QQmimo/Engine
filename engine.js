...
/***/ "./GameEngine/GameComponents/Dictionary.ts":
/*!*************************************************!*\
  !*** ./GameEngine/GameComponents/Dictionary.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Dictionary: () => (/* binding */ Dictionary)\n/* harmony export */ });\n/* harmony import */ var _GameObject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../GameObject */ \"./GameEngine/GameObject/index.ts\");\n\nclass Dictionary extends _GameObject__WEBPACK_IMPORTED_MODULE_0__.Component {\n    constructor() {\n        super(...arguments);\n        this.List = new Map();\n        this.set = (key, value) => {\n            this.List.set(key, value);\n        };\n        this.get = (key) => {\n            return this.List.get(key);\n        };\n        this.delete = (key) => {\n            this.List.delete(key);\n        };\n    }\n}\n\n\n//# sourceURL=webpack://engine/./GameEngine/GameComponents/Dictionary.ts?");
